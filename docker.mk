...
## drush	:	Executes `drush` command in a specified `DRUPAL_ROOT` directory (default is `/var/www/html/docroot`).
##		To use "--flag" arguments include them in quotation marks.
...
%:
	@: -ti $(shell docker ps --filter name='$(PROJECT_NAME)_php' --format "{{ .ID }}") sh
